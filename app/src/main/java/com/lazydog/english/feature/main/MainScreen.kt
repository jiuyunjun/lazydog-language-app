...
fun MainScreen(
    ...
    onStartProofChallenge: () -> Unit,
    onStartReading: () -> Unit,
    onStartReadingPaste: () -> Unit,
    onStartNativeReading: () -> Unit,
    onStartScenario: () -> Unit,
    onOpenScenario: (Long) -> Unit,
    onOpenMaterial: (Long, Boolean) -> Unit,
